            ...
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                ...
                launch {
                    viewModel.transcodingFloatModeEnabled.collectLatest {
                        ...
                        when (it == true) {
                            true -> outputHeaderListItem.setSupportingText(
                                R.string.audio_output_not_available_in_float_mode
                            )

                            false -> outputHeaderListItem.supportingText = null
                        }

                        outputItemsLinearLayout.isVisible = it != true
                    }
                }
