...
class ProviderSelectorDialogFragment : DialogFragment(R.layout.fragment_provider_selector_dialog) {
    ...
    // Recyclerview
    private val adapter = object : SimpleListAdapter<ProviderInstance, ListItem>(
        ...
        override fun ViewHolder.onPrepareView() {
            view.setOnClickListener {
                item?.let {
                    viewModel.setNavigationProviderInstance(it)
        ...
        override fun ViewHolder.onBindView(item: ProviderInstance) {
